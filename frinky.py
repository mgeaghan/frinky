...
def check_args(args=None):
	...
	parser.add_argument('-G', '--gif', help="Specify an animation should be returned with the specified timeframe in seconds (e.g. -G 2.5). Returns an animation of specified length starting from first best match or from specified timestamp of specified episode.", default="")
